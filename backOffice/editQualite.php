...
// je vais chercher mon id d'article
    if (array_key_exists('id',$_GET)){
        ...
        $sth = $dbh->prepare('SELECT titre, icone FROM qualite WHERE id=:id');
        ...
        {    
            ...
            $bdd = connexion();
            // injection bdd
            $sth1= $bdd->prepare('UPDATE qualite SET titre = :titre, icone = :icone WHERE id=:id');
